...
public class CashContent{
	...
	private double getCashFactory(int mode, double money, int number){
		...
		return cashCal.getTotalPrice();
	}
	
	public double getContentResult(int mode, double money, int number){
		return this.getCashFactory(mode, money, number);
	}
}
